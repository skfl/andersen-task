...
public class OrderSQLCommands {
   ...
   static String SQL_UPDATE = "update orders set cost = ?, status = ?, time-of-completing = ?" +
           " where id = ?";

   static String SQL_INSERT = "insert into orders(cost,status,time_of_completing) " +
           "values (?, ?, ?))";
