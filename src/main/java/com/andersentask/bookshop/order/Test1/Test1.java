...
import com.andersentask.bookshop.order.repositories.OrderCollectionRepositoryImpl;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        OrderService orderService = new OrderService(new OrderCollectionRepositoryImpl());
